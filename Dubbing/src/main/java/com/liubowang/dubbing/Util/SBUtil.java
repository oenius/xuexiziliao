...
public class SBUtil {
    ...
    public static String getTimeFormat(int videoTime){
        int timeMMS = videoTime % 1000;
        int second = videoTime / 1000;
        int timeH = second / 3600;
        int timeS = second % 60;
        int timeM = second % 3600 / 60;
        return String.format("%02d:%02d:%02d:%02d",timeH,timeM,timeS,timeMMS/10);
    }
    public static String getTimeFormatShort(int videoTime){
        int second = videoTime / 1000;
        int timeH = second / 3600;
        int timeS = second % 60;
        int timeM = second % 3600 / 60;
