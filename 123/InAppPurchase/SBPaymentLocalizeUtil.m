//
//  SBPaymentLocalizeUtil.m
//  PrivateAlbum
//
//  Created by mayuan on 16/7/1.
//  Copyright © 2016年 vae. All rights reserved.
//

#import "SBPaymentLocalizeUtil.h"

@implementation SBPaymentLocalizeUtil
...
+ (NSString *)localizedStringForKey:(NSString *)key withDefault:(NSString *)defaultString
{
    ...
    if (bundle == nil)
    {
        NSString *bundlePath  = [[NSBundle bundleForClass:[self class]] pathForResource:@"SBPayment" ofType:@"bundle"];
