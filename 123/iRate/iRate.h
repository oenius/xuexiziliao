...
@property (nonatomic, copy) NSString *latestVersion;   // latestVersion on appstore
@property (nonatomic, copy) NSString *applicationBundleID;
@property (nonatomic, copy) NSString *appStoreTrackName;
...
@property (nonatomic, strong) NSDate *currentLaunchedTime;
