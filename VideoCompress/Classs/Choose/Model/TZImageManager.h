...
UIKIT_EXTERN NSString *const kAssetFilesizeKey;     ///NSNumber->NSInteger
UIKIT_EXTERN NSString *const kAssetThumImageKey;    ///UIImage
UIKIT_EXTERN NSString *const kAssetPixelWidthKey;   ///NSNumber->NSInteger
UIKIT_EXTERN NSString *const kAssetPixelHeightKey;  ///NSNumber->NSInteger
UIKIT_EXTERN NSString *const kAssetBitrateKey;      ///NSNumber->CGFloat
UIKIT_EXTERN NSString *const kAssetDurationKey;     ///NSNumber->CGFloat
UIKIT_EXTERN NSString *const kAssetCreationDate;    ///NSDate
UIKIT_EXTERN NSString *const kAssetAVAssetKey;      ///avasset
