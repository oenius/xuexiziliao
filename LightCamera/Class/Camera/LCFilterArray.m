...
@implementation LCFilterArray

+(NSArray *)filterArray{
    NSMutableArray * arr = [NSMutableArray arrayWithCapacity:0];

    
    GPUImageOutput<GPUImageInput> * Filter1 = [[GPUImageExposureFilter alloc] init];
    [(GPUImageExposureFilter *)Filter1 setExposure:0.0];
    NSString * title1 = NSLocalizedString(@"RepaymentRemind.none", @"None");
    NSDictionary * dic1 = [NSDictionary dictionaryWithObjectsAndKeys:Filter1,@"filter",title1,@"name", nil];
    [arr addObject:dic1];
    
    GPUImageOutput<GPUImageInput> * Filter2 = [[GPUImageRGBFilter alloc] init];
    NSString * title2 = NSLocalizedString(@"Green", @"Green");
    [(GPUImageRGBFilter *)Filter2 setRed:0.0];
    [(GPUImageRGBFilter *)Filter2 setGreen:1.0];
    [(GPUImageRGBFilter *)Filter2 setBlue:0.0];
    NSDictionary * dic2 = [NSDictionary dictionaryWithObjectsAndKeys:Filter2,@"filter",title2,@"name", nil];
    [arr addObject:dic2];
    
    
//    GPUImageOutput<GPUImageInput> * Filter3 = [[GPUImageColorPackingFilter alloc] init];GPUImageGrayscaleFilter
    GPUImageOutput<GPUImageInput> * Filter3 = [[GPUImageGrayscaleFilter alloc] init];
    NSString * title3 = NSLocalizedString(@"NC.Noir", @"NC.Noir");
    NSDictionary * dic3 = [NSDictionary dictionaryWithObjectsAndKeys:Filter3,@"filter",title3,@"name", nil];
    [arr addObject:dic3];
    
    GPUImageOutput<GPUImageInput> * Filter4 = [[GPUImageColorInvertFilter alloc] init];
    NSString * title4 = NSLocalizedString(@"NC.ColorInvert", @"Color reversal");
    NSDictionary * dic4 = [NSDictionary dictionaryWithObjectsAndKeys:Filter4,@"filter",title4,@"name", nil];
    [arr addObject:dic4];
    
    GPUImageOutput<GPUImageInput> * Filter5 = [[GPUImageRGBFilter alloc] init];
    NSString * title5 = NSLocalizedString(@"NC.Red", @"Red");
    [(GPUImageRGBFilter *)Filter5 setRed:1.0];
    [(GPUImageRGBFilter *)Filter5 setGreen:0.0];
    [(GPUImageRGBFilter *)Filter5 setBlue:0.0];
    NSDictionary * dic5 = [NSDictionary dictionaryWithObjectsAndKeys:Filter5,@"filter",title5,@"name", nil];
    [arr addObject:dic5];
    
    GPUImageOutput<GPUImageInput> * Filter6 = [[GPUImageRGBFilter alloc] init];
    NSString * title6 = NSLocalizedString(@"NC.blue", @"Blue");
    [(GPUImageRGBFilter *)Filter6 setRed:0.0];
    [(GPUImageRGBFilter *)Filter6 setGreen:0.0];
    [(GPUImageRGBFilter *)Filter6 setBlue:1.0];
    NSDictionary * dic6 = [NSDictionary dictionaryWithObjectsAndKeys:Filter6,@"filter",title6,@"name", nil];
    [arr addObject:dic6];
    
    GPUImageOutput<GPUImageInput> * Filter7 = [[GPUImageSketchFilter alloc] init];
    [(GPUImageSketchFilter *)Filter7 setEdgeStrength:1.2];
    NSString * title7 = NSLocalizedString(@"NC.Sketch", @"Sketch");
...
//    [(GPUImageMonochromeFilter *)Filter11 setColorRed:0.0 green:1.0 blue:0.0];
//    NSString * title11 = @"绿色";
