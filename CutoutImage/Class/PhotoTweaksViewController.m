...
- (void)setupSubviews
{
    ...
    UIBarButtonItem * cancelItem = [[UIBarButtonItem alloc]initWithTitle:CI_Cancel style:(UIBarButtonItemStylePlain) target:self action:@selector(cancelBtnTapped)];
    
    UIBarButtonItem * sureItem = [[UIBarButtonItem alloc]initWithTitle:CI_Sure style:(UIBarButtonItemStylePlain) target:self action:@selector(saveBtnTapped)];
    
    UIBarButtonItem * resetItem = [[UIBarButtonItem alloc]initWithTitle:CI_Reset style:(UIBarButtonItemStylePlain) target:self action:@selector(resetBtnTapped)];
    
    self.navigationItem.leftBarButtonItems = @[cancelItem,resetItem];
